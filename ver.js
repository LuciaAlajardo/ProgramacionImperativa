...
// Las propiedades que tiene el objeto alumnos es, ID, NOMBRE, APELLIDO, LEGAJO Y NOTAS.
...
const alumnos = [
    ...
    //console.log(alumno.promedio);; //no funciona
    ...
    //console.log(ordenarDesc(alumno.notas)); //funciona
    ...
    //console.table(crearMatriz); //funciona
    ...
    //console.log(multiplo(crearMatriz)); // funciona
    ...
    //console.log(sumarLaMatriz(crearMatriz)); //funciona
    ...
    console.log(sumaDeDiagonal(crearMatriz)); //funciona